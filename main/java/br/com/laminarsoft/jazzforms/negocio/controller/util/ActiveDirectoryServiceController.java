...
public class ActiveDirectoryServiceController extends AutenticacaoCorporativa implements Serializable {
	...
	private static ActiveDirectoryServiceController AD_SERVICE;
	...
	public static ActiveDirectoryServiceController getInstance() {
		if(AD_SERVICE == null) {
			AD_SERVICE = new ActiveDirectoryServiceController();
		}
		return AD_SERVICE;
	}
	
	
	public ActiveDirectoryServiceController() {
